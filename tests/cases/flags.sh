...
echo 'echo rcrc $#*; fn fromrc {echo fromrc}' > lib/rcrc; rc -c 'echo c; whatis fromrc'; echo 'echo stdin' | rc; rc ./script.rc a; rc -l -c 'echo login'; echo 'echo i; fromrc' | rc -i 2>&1; echo 'echo li' | rc -l -i 2>&1; rc -i -c 'echo ic' 2>&1; echo 'echo si' | rc -i ./script.rc 2>&1; rc -m mymain; rm lib/profile lib/rcrc
rc -m; echo "code=$?"
